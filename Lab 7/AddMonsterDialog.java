...
public class AddMonsterDialog extends JDialog implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == cancelButton) {
			...
			Monster mons = Trainer.createMonster((String) typeCombo.getSelectedItem(), (Integer)hitPointSpinner.getValue(), 
					new Attack[] { new Attack(attack1Field.getText(), (Integer)attack1Spinner.getValue()), 
							new Attack(attack2Field.getText(), (Integer)attack2Spinner.getValue())});
			trainer.addMonster(mons);
			model.addElement(mons);
			dispose();
		}
	}
